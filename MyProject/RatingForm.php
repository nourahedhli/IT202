...
$userID = get_user_id();
$db = getDB();
$stmt = $db->prepare("SELECT Orders.id,OrderItems.product_id FROM Orders JOIN OrderItems ON Orders.id = OrderItems.order_id  where Orders.user_id =:id  AND OrderItems.product_id = :product_id ");
