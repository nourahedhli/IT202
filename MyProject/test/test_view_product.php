...
if (isset($id)) {
    ...
    $stmt = $db->prepare("SELECT Products.id,name,quantity,price,description,modified,created, user_id, Users.username FROM Products as Products JOIN Users on Products.user_id = Users.id where Products.id = :id");
